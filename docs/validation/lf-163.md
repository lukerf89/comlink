...
This records the initial preview. The [2026-09-24 Fn hotkey follow-up](lf-163-hotkeys.md) supersedes the original shortcut/config boundaries and records the latest validation.
